...
const { Route: SessionRoute } = await import('~/routes/api/public/scheduling/$invitationId/session')
const { Route: InvitationRoute } = await import('~/routes/api/public/scheduling/$invitationId/index')
const { Route: SlotsRoute } = await import('~/routes/api/public/scheduling/$invitationId/slots')
const { Route: SubmissionRoute } = await import('~/routes/api/public/scheduling/$invitationId/submission')
const { Route: BookRoute } = await import('~/routes/api/public/scheduling/$invitationId/book')
const { Route: CancelRoute } = await import('~/routes/api/public/scheduling/$invitationId/cancel')
const { Route: DeclineRoute } = await import('~/routes/api/public/scheduling/$invitationId/decline')
const { Route: WithdrawRoute } = await import('~/routes/api/public/scheduling/$invitationId/withdraw')
