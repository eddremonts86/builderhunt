...
import { authUsers, billingCreditGrants, billingCustomers, billingSubscriptions, organizationMembers, organizations } from '~/shared/lib/db/schema'
import { SUBSCRIPTION_CATALOG } from '~/shared/lib/billing/catalog'
import { BillingProviderError, type ChangeSubscriptionInput as ProviderChangeSubscriptionInput } from '~/shared/lib/billing/provider'
...
vi.mock('~/shared/lib/organizations/contracts', async (importOriginal) => {
  const actual = await importOriginal<typeof import('~/shared/lib/organizations/contracts')>()
...
} from '~/shared/lib/billing/subscription-changes'
