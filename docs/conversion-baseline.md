...
Plan: `plans/phase-1/50-audit-conversion`. Created 2026-07-26, instrumentation-only phase
...
pass** — see `plans/phase-1/50-audit-conversion/tasks.md` for what's deferred and why.
...
- Performance budgets: see `plans/phase-1/48-audit-performance-qa/spec.md` (already has a running
