/**
 * Subscription preview and change matrix (plans/implemented/30-stripe-billing-platform/tasks.md §7 "Implement
 ...
 * (plans/implemented/30-stripe-billing-platform/tasks.md §7 "Enforce Team downgrade seat blockers"). Reuses the
