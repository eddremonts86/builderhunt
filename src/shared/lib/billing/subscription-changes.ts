/**
 * Subscription preview and change matrix (plans/phase-1/30-stripe-billing-platform/tasks.md §7 "Implement
 ...
 * (plans/phase-1/30-stripe-billing-platform/tasks.md §7 "Enforce Team downgrade seat blockers"). Reuses the
