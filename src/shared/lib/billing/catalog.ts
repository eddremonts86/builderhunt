 ...
 * migration in plans/implemented/30-stripe-billing-platform/tasks.md §10 ("Migrate manual
...
export const SUBSCRIPTION_CATALOG: Record<SubscriptionCatalogKey, SubscriptionCatalogEntry> = {
  pro_monthly: {
    ...
    version: 1, currency: 'usd', taxBehavior: 'exclusive', stripePriceId: { test: 'price_1TwgTyFbQx9fJlcGDk3Xgcgx', live: 'price_1TwfDPFbQx9fJlcGq5lrPtGz' },
  ...
  pro_annual: {
    ...
    version: 1, currency: 'usd', taxBehavior: 'exclusive', stripePriceId: { test: 'price_1TwgTyFbQx9fJlcGDp2YBY6Z', live: 'price_1TwfDPFbQx9fJlcGr9njS4a5' },
    effectiveAt: EFFECTIVE_AT, retiredAt: null,
  },
  pro_max_monthly: {
    key: 'pro_max_monthly', tier: 'pro_max', interval: 'monthly', amountCents: 7900, monthlyCredits: 700, seatLimit: 1,
    version: 1, currency: 'usd', taxBehavior: 'exclusive', stripePriceId: { test: 'price_1TwgTzFbQx9fJlcGUYDWsnD7', live: 'price_1TwfDQFbQx9fJlcG4YFpbzb2' },
    effectiveAt: EFFECTIVE_AT, retiredAt: null,
  },
  pro_max_annual: {
    key: 'pro_max_annual', tier: 'pro_max', interval: 'annual', amountCents: 75800, monthlyCredits: 700, seatLimit: 1,
    version: 1, currency: 'usd', taxBehavior: 'exclusive', stripePriceId: { test: 'price_1TwgU0FbQx9fJlcGkuc42qjM', live: 'price_1TwfDRFbQx9fJlcGqjoqti5M' },
    effectiveAt: EFFECTIVE_AT, retiredAt: null,
  },
  team_monthly: {
    key: 'team_monthly', tier: 'team', interval: 'monthly', amountCents: 19900, monthlyCredits: 2100, seatLimit: 10,
    version: 1, currency: 'usd', taxBehavior: 'exclusive', stripePriceId: { test: 'price_1TwgU1FbQx9fJlcGl4oB4gEu', live: 'price_1TwfDSFbQx9fJlcG1jAyebwz' },
    effectiveAt: EFFECTIVE_AT, retiredAt: null,
  },
  team_annual: {
    key: 'team_annual', tier: 'team', interval: 'annual', amountCents: 191000, monthlyCredits: 2100, seatLimit: 10,
    version: 1, currency: 'usd', taxBehavior: 'exclusive', stripePriceId: { test: 'price_1TwgU1FbQx9fJlcGIpLSpGjS', live: 'price_1TwfDSFbQx9fJlcGGu9dLNKz' },
    effectiveAt: EFFECTIVE_AT, retiredAt: null,
  },
}
...
export const PACK_CATALOG: Record<PackCatalogKey, PackCatalogEntry> = {
  starter_300: {
    ...
    version: 1, currency: 'usd', taxBehavior: 'exclusive', stripePriceId: { test: 'price_1TwgU2FbQx9fJlcGryncAlgN', live: 'price_1TwfDTFbQx9fJlcG3Uzc83pg' },
    effectiveAt: EFFECTIVE_AT, retiredAt: null,
  },
  scale_1000: {
    key: 'scale_1000', amountCents: 4500, credits: 1000, expiryMonths: 12,
    version: 1, currency: 'usd', taxBehavior: 'exclusive', stripePriceId: { test: 'price_1TwgU3FbQx9fJlcGqcHyeyj7', live: 'price_1TwfDUFbQx9fJlcGqGSlhriD' },
    effectiveAt: EFFECTIVE_AT, retiredAt: null,
  },
  max_5000: {
    key: 'max_5000', amountCents: 29900, credits: 5000, expiryMonths: 12,
    version: 1, currency: 'usd', taxBehavior: 'exclusive', stripePriceId: { test: 'price_1TwgU4FbQx9fJlcGrdEwPp2V', live: 'price_1TwfDVFbQx9fJlcGytb38ChQ' },
    effectiveAt: EFFECTIVE_AT, retiredAt: null,
  },
}
