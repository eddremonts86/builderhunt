...
export interface BillingOperationsMetrics {
  ...
  /** Cost/margin tracking does not exist yet (plans/implemented/30-stripe-billing-platform/tasks.md §10 "Create accounting and margin export") — reported explicitly rather than a fabricated number. */
...
/**
 * SLO thresholds for the platform billing operations metrics (plans/implemented/30-stripe-billing-platform/
