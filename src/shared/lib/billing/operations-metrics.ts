...
export interface BillingOperationsMetrics {
  ...
  /** Cost/margin tracking does not exist yet (plans/phase-1/30-stripe-billing-platform/tasks.md §10 "Create accounting and margin export") — reported explicitly rather than a fabricated number. */
...
/**
 * SLO thresholds for the platform billing operations metrics (plans/phase-1/30-stripe-billing-platform/
