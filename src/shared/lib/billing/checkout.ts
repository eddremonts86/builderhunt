/**
 * Idempotent subscription Checkout Session creation (plans/phase-1/29-stripe-billing-platform/tasks.md §5
 ...
 * by the webhook handler (plans/phase-1/29-stripe-billing-platform/tasks.md §6, not yet built) once Stripe
