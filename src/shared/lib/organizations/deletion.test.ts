...
vi.mock('../auth/organization-lifecycle', async (importOriginal) => {
  const actual = await importOriginal<typeof import('../auth/organization-lifecycle')>()
  return {
    ...actual,
...
vi.mock('../billing/subscription-changes', async (importOriginal) => {
  const actual = await importOriginal<typeof import('../billing/subscription-changes')>()
  return {
    ...actual,
...
vi.mock('../repositories/account-privacy', async (importOriginal) => {
  const actual = await importOriginal<typeof import('../repositories/account-privacy')>()
...
const { requestNormalDeletion, requestImmediateDeletion, finalizeOrganizationDeletion, OrganizationDeletionError } = await import('./deletion')
const { SubscriptionChangeError } = await import('../billing/subscription-changes')
