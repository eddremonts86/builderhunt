/**
 * The only surface Team-account modules (plans/implemented/27-team-accounts) may import
 ...
 * (plans/implemented/30-stripe-billing-platform/tasks.md §7 "Enforce Team downgrade seat blockers"). `currentSeatsUsed`
