 ...
 * surface needs (plans/phase-1/29-stripe-billing-platform/tasks.md §3). Every function
...
/**
 * The one repair reconciliation.ts (plans/phase-1/29-stripe-billing-platform/tasks.md §10 "Implement daily
...
// ---------------------------------------------------------------------------
// Auto-recharge (plans/phase-1/29-stripe-billing-platform/tasks.md §8 "Implement capped
