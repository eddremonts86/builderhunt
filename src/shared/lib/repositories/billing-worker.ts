/**
 * Worker-only, cross-organization billing data access (plans/implemented/30-stripe-billing-platform/tasks.md §6
...
/** Annual subscriptions in good standing (`active`/`trialing`) for the sweep that issues the remaining 11 monthly credit windows (plans/implemented/30-stripe-billing-platform/tasks.md §7 "Issue annual subscription credits monthly") — stops naturally once a subscription lapses into any other status. */
 ...
 * untouched) — the seven-day grace/block worker (plans/implemented/30-stripe-billing-platform/tasks.md §7
