...
function ImprintPage() {
  return (
    <article className="min-h-[calc(100vh-4rem)] p-6 max-w-3xl mx-auto" data-testid="legal-imprint">
      ...
      <div className="card p-6 space-y-4" data-testid="imprint-card">
        <section>
        ...
        <section>
          ...
          <p className="text-bh-text-muted text-sm">
