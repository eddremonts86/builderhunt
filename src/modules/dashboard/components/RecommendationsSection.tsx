          ...
          <div className="flex flex-wrap gap-2">
            ...
            {STARTER_SUGGESTIONS.map((q) => (
              <a
                ...
                className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-bh-surface border border-bh-border text-sm text-bh-text-muted hover:border-bh-accent hover:text-bh-accent transition-colors"
              >
