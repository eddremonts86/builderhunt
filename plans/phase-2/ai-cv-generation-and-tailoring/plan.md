...
> **Status**: `pending`
> **Depends on**: [`job-opportunities-workspace`](../job-opportunities-workspace/spec.md) (sólo las fases 6–7; las fases 1–5 no lo necesitan), [`ai-expansion`](../../phase-1/ai-expansion/spec.md), [`security-and-multitenancy`](../../phase-1/security-and-multitenancy/spec.md)
