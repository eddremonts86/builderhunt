...
> **Status**: `pending`
> **Depends on**: nothing (pure read-only consumer of `src/lib/score.ts` and `builder_source_snapshots`). Files new connector findings against [`audit-trust`](../../phase-1/51-audit-trust/spec.md) and must respect [`project-hygiene`](../../phase-1/04-project-hygiene/spec.md) (no synthetic evidence presented as measured fact).
...
- [ ] **File the connector defects the panel exposes**
  - Files: `plans/phase-1/51-audit-trust/tasks.md`
  ...
  - Verify: `plans/phase-1/51-audit-trust/tasks.md` contains five new `- [ ]` items with citations.
