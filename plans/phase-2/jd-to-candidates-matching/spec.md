...
- **Not `solutions-intelligence`.** That plan turns a *structured `SolutionBrief`* into up to
  ...
  ([`solutions-intelligence`](../../phase-1/42-solutions-intelligence/spec.md)). This plan turns
...
[`legal-and-compliance`](../../phase-1/03-legal-and-compliance/spec.md)) already names MiniMax M3 and
