...
- **Same person on several sources**: signals key on `builder_identity_id`, which is per
  ...
  [`unified-timeline`](../../phase-1/unified-timeline/spec.md).
