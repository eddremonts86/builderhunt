...
> **Status**: `pending`
> **Depends on**: [`security-and-multitenancy`](../../phase-1/01-security-and-multitenancy/spec.md) (tenant principal, `withTenantContext`, RLS forzado, `organization_id NOT NULL` — CERRADO 2026-07-27), [`ai-expansion`](../../phase-1/21-ai-expansion/spec.md) (registro `AI_TASKS`, `wrapUntrusted`, cache, budget), [`stealth-scraping`](../../phase-1/42-stealth-scraping/spec.md) (`safeFetch`, robots, registro de políticas de fuente), [`stripe-billing-platform`](../../phase-1/30-stripe-billing-platform/spec.md) (`rate-cards.ts` + `feature-authorization.ts`: reserva/settle/release)
