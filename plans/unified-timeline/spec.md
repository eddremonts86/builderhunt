...
> **Status**: `pending`
> **Depends on**: nothing hard. Soft: [`ai-expansion`](../ai-expansion/spec.md) (only for
...
> **Blocks**: nothing. [`smart-alerts`](../smart-alerts/spec.md)' future "real event
> detection" phase would consume these fetchers; [`portfolio-builder`](../portfolio-builder/spec.md)
