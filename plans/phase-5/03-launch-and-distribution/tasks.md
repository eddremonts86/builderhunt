...
> **Provenance**: ten tasks moved from `plans/implemented/phase-1/54-waitlist-launch` and
> `plans/implemented/phase-1/46-content-marketing` on 2026-08-05, on Edd's instruction. A launch cannot be performed
...
- [ ] **Publish "The solo founder's guide to technical sourcing"**
  ...
  - Moved from `plans/implemented/phase-1/46-content-marketing` Phase 3 on 2026-08-05.
...
- [ ] **Submit the sitemap and confirm the previews**
  ...
  - Moved from `plans/implemented/phase-1/54-waitlist-launch` Phase 2 on 2026-08-05.
...
- [ ] **Show HN post**
  ...
  - Moved from `plans/implemented/phase-1/54-waitlist-launch` Phase 4 on 2026-08-05.
...
- [ ] **Cross-post to dev.to, X, LinkedIn, one subreddit and Indie Hackers**
  ...
  - Moved from `plans/implemented/phase-1/54-waitlist-launch` Phase 4 and
    `plans/implemented/phase-1/46-content-marketing` Phase 2 on 2026-08-05 — they were the same task written twice,
...
- [ ] **Monitor daily through launch week, then weekly**
  ...
  - Moved from `plans/implemented/phase-1/54-waitlist-launch` Phase 5 on 2026-08-05.
