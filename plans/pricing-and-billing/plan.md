...
> future work moved to [`stripe-billing-platform`](../stripe-billing-platform/plan.md); this file is
...
These now execute only through [`stripe-billing-platform`](../stripe-billing-platform/plan.md), which
