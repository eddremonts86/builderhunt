...
> **Status**: `pending`
> **Depends on**: nothing hard. Soft: [`ai-expansion`](../20-ai-expansion/spec.md) (only for
...
> **Blocks**: nothing. [`smart-alerts`](../33-smart-alerts/spec.md)' future "real event
> detection" phase would consume these fetchers; [`portfolio-builder`](../36-portfolio-builder/spec.md)
