...
- [ ] **Replace raw saved-query RSS access with a public feed capability**
  - Files: `src/shared/lib/db/schema.ts`, `src/shared/lib/repositories/public-feeds.ts`, `src/routes/api/feeds/$feedId.ts`, `plans/phase-1/35-rss-feeds/{spec,plan,tasks}.md`, `test/security/public-feed-capabilities.test.ts`
