...
> **Depends on**: [`ai-expansion`](../20-ai-expansion/spec.md)
> **Blocks**: [`team-synergy`](../39-team-synergy/spec.md) (soft), [`work-sample`](../37-work-sample/spec.md) (soft — shared `src/lib/github/content.ts`)
...
module is deliberately task-agnostic — [`work-sample`](../37-work-sample/plan.md) reuses it.
