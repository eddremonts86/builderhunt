...
> **Status**: `blocked`
> **Depends on**: [`security-and-multitenancy`](../01-security-and-multitenancy/tasks.md), [`team-accounts`](../26-team-accounts/tasks.md)
> **Blocks**: [`activity-feed`](../28-activity-feed/tasks.md)
...
- [ ] **Replace raw saved-query RSS access with a public feed capability**
  - Files: `src/shared/lib/db/schema.ts`, `src/shared/lib/repositories/public-feeds.ts`, `src/routes/api/feeds/$feedId.ts`, `plans/phase-1/34-rss-feeds/{spec,plan,tasks}.md`, `test/security/public-feed-capabilities.test.ts`
