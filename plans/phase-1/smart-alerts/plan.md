...
> **Depends on**: nothing (Phase 3 is optional and depends on [`ai-expansion`](../ai-expansion/spec.md))
...
- Real event detection (`new_repo` as an actual repo-creation event) consuming
  [`unified-timeline`](../unified-timeline/spec.md) fetchers.
- `new_product` semantics once [`producthunt-integration`](../producthunt-integration/spec.md) exists.
