...
> `ENRICHMENT_ENABLED=false` everywhere. See plans/phase-1/41-stealth-scraping/task.md for exact gaps.)
...
> context, worker role, and RLS, [`legal-and-compliance`](../03-legal-and-compliance/spec.md) for
