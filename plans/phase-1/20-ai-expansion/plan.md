...
> **Depends on**: [`security-and-multitenancy`](../01-security-and-multitenancy/plan.md) (tenant-scoped budgets, caches, artifacts, logs, and organization entitlements)
> **Blocks**: [`semantic-search`](../21-semantic-search/spec.md), [`ai-profile-enrichment`](../23-ai-profile-enrichment/spec.md), [`outreach-generator`](../25-outreach-generator/spec.md), [`code-fingerprinting`](../24-code-fingerprinting/spec.md), [`ai-sourcing-sprints`](../40-ai-sourcing-sprints/spec.md), [`team-synergy`](../39-team-synergy/spec.md), [`work-sample`](../37-work-sample/spec.md), [`proactive-discovery`](../22-proactive-discovery/spec.md)
