...
> [`team-accounts`](../26-team-accounts/tasks.md)
> **Blocks**: [`calendar-scheduling-interview-intelligence`](../43-calendar-scheduling-interview-intelligence/tasks.md)
...
- [x] **Enforce Team downgrade seat blockers**
  ...
  - Progress (2026-07-23): Reuses the EXACT same seat count `getSeatUsage` (organization-lifecycle.ts,
    already shipped by plans/phase-1/26-team-accounts) already enforces at invite time — "accepted members plus
...
- [x] **Update pricing for the approved catalog**
  - Files: `src/routes/_landing/pricing.tsx`, `tests/unit/routes/_landing/pricing.test.tsx`, `src/shared/lib/billing-shared.ts`, `test/test-pricing-and-billing.mjs`
...
- [x] **Retire legacy billing mutations after canonical cutover**
  - Files: `src/shared/lib/repositories/platform-billing.ts`, `tests/unit/shared/lib/repositories/platform-billing.test.ts`, `src/shared/lib/billing.ts`, `src/routes/api/plans/request-upgrade.ts`, `tests/unit/routes/api/plans/request-upgrade.test.ts`, `src/routes/api/admin/plan-requests/index.ts`, `tests/unit/routes/api/admin/plan-requests/index.test.ts`, `src/routes/_dashboard/admin/plan-requests.tsx`, `test/test-pricing-and-billing.mjs`
...
- [x] **Reconcile dependent plan documents**
  - Files: `plans/phase-1/43-calendar-scheduling-interview-intelligence/spec.md`, `plans/phase-1/43-calendar-scheduling-interview-intelligence/plan.md`
