...
> **Status**: `pending`
> **Depends on**: [`ai-expansion`](../20-ai-expansion/spec.md) (hard), [`code-fingerprinting`](../24-code-fingerprinting/spec.md) (soft), [`ai-profile-enrichment`](../23-ai-profile-enrichment/spec.md) (soft), [`team-accounts`](../26-team-accounts/spec.md) (soft)
> **Blocks**: nothing
