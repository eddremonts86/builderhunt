...
> **Depends on**: [`ai-expansion`](../20-ai-expansion/spec.md) (AI Platform — `minimaxChat`, task registry, cache, budgets must exist through Phase 3)
> **Blocks**: nothing
...
[`semantic-search`](../21-semantic-search/spec.md)), enrichment can migrate to it; `version: 1`
