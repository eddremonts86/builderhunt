...
> completed canonical tenant cutover/RLS, [`ai-expansion`](../20-ai-expansion/spec.md) for the
> existing AI task registry, budgets, kill switches, and structured-output validation, and
> [`stripe-billing-platform`](../29-stripe-billing-platform/spec.md) for subscriptions, credits,
...
> [`stripe-billing-platform`](../29-stripe-billing-platform/spec.md) plan is now built (real Stripe
...
- Billing dependency: [`stripe-billing-platform`](../29-stripe-billing-platform/spec.md) owns Stripe,
...
[`stripe-billing-platform`](../29-stripe-billing-platform/spec.md). Interview acceptance tests pin the
