...
> [`ai-expansion`](../20-ai-expansion/spec.md), and
...
- [ ] **Verify the billing platform certification dependency**
  - Files: `plans/phase-1/29-stripe-billing-platform/tasks.md`, `docs/operations/stripe-sandbox-certification.md`,
...
- [ ] **Verify unit economics in test and limited live mode**
  - Files: `docs/operations/interview-runtime-verification.md`,
    `plans/phase-1/43-calendar-scheduling-interview-intelligence/spec.md`
...
- [ ] **Close Definition of Done with runtime evidence**
  - Files: `docs/operations/interview-runtime-verification.md`,
    `plans/phase-1/43-calendar-scheduling-interview-intelligence/spec.md`,
    `plans/phase-1/43-calendar-scheduling-interview-intelligence/plan.md`,
    `plans/phase-1/43-calendar-scheduling-interview-intelligence/tasks.md`
