...
> **Depends on**: [`security-and-multitenancy`](../security-and-multitenancy/plan.md) for database-role, RLS, restore, and tenant-aware production enforcement; existing non-database operations may proceed independently
