...
> **Depends on**: [`security-and-multitenancy`](../01-security-and-multitenancy/plan.md) (hard — tenant persistence, budgets, worker context, and RLS); [`ai-expansion`](../20-ai-expansion/spec.md) (hard); [`semantic-search`](../21-semantic-search/spec.md) (optional index write-through); [`proactive-discovery`](../22-proactive-discovery/spec.md) (pattern only); [`team-accounts`](../26-team-accounts/spec.md) and [`shared-resources`](../27-shared-resources/spec.md) (Future sharing only)
> **Blocks**: nothing
...
and 37-work-sample/code analysis remain separate future work.
