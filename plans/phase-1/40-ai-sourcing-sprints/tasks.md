...
> **Depends on**: [`security-and-multitenancy`](../01-security-and-multitenancy/tasks.md) (hard — tenant persistence, budgets, worker context, and RLS); [`ai-expansion`](../20-ai-expansion/tasks.md) (hard); [`semantic-search`](../21-semantic-search/tasks.md) (optional adapter); [`proactive-discovery`](../22-proactive-discovery/tasks.md) (pattern only); [`team-accounts`](../26-team-accounts/tasks.md) and [`shared-resources`](../27-shared-resources/tasks.md) (Future sharing only)
> **Blocks**: nothing
...
- PDF/DOCX extraction, normalized geocoding/MapLibre, and 37-work-sample/code analysis as separate plans.
