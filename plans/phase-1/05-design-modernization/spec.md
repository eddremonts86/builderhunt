...
> **Status**: `pending`
> **Depends on**: nothing
> **Blocks**: nothing (it feeds the release audits — [`audit-visual-system`](../49-audit-visual-system/spec.md),
> [`audit-accessibility`](../47-audit-accessibility/spec.md), [`audit-conversion`](../50-audit-conversion/spec.md),
> [`audit-performance-qa`](../48-audit-performance-qa/spec.md))
