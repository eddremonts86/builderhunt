...
> **Depends on**: [`security-and-multitenancy`](../01-security-and-multitenancy/tasks.md) (hard — tenant persistence, budgets, worker context, and RLS); [`ai-expansion`](../21-ai-expansion/tasks.md) (hard); [`semantic-search`](../22-semantic-search/tasks.md) (optional adapter); [`proactive-discovery`](../23-proactive-discovery/tasks.md) (pattern only); [`team-accounts`](../27-team-accounts/tasks.md) and [`shared-resources`](../28-shared-resources/tasks.md) (Future sharing only)
> **Blocks**: nothing
...
- PDF/DOCX extraction, normalized geocoding/MapLibre, and 38-work-sample/code analysis as separate plans.
