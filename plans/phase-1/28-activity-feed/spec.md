...
> **Status**: `blocked`
> **Depends on**: [`security-and-multitenancy`](../01-security-and-multitenancy/spec.md), [`team-accounts`](../26-team-accounts/spec.md), [`shared-resources`](../27-shared-resources/spec.md)
> **Blocks**: nothing
