...
> **Depends on**: [`audit-performance-qa`](../48-audit-performance-qa/spec.md), [`pricing-and-billing`](../30-pricing-and-billing/spec.md), [`legal-and-compliance`](../03-legal-and-compliance/spec.md), [`claimable-profiles`](../35-claimable-profiles/spec.md)
...
- [x] **Replace email-only builder verification with source proof** — done, but by an earlier
  ...
  - This plan's task duplicates that work almost exactly (require a matching source-hosted
    ...
    `plans/phase-1/35-claimable-profiles/tasks.md`'s "Canonical identity and proof" section for the
