...
> **Status**: `superseded` — merged into [`work-sample`](../38-work-sample/plan.md)
...
- Interview-question generation from real code → **delivered by**
  [`work-sample`](../38-work-sample/plan.md) (`suggestedInterviewQuestions`).
- Streaming chat infrastructure → **rejected** (AI platform v1 is single JSON completions;
  see [`ai-expansion`](../21-ai-expansion/spec.md) non-goals).
