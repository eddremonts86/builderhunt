...
> **Depends on**: [`semantic-search`](../21-semantic-search/spec.md) (hard — needs
> `builder_embeddings` + `upsertEmbeddingStubs` from its Phases 1–2)
> **Blocks**: nothing hard — enhances semantic-search cold start;
> [`ai-sourcing-sprints`](../40-ai-sourcing-sprints/spec.md) reuses the cell-cursor worker pattern
