...
> **Depends on**: [`semantic-search`](../21-semantic-search/spec.md) (hard — Phases 1–2:
...
- `discovery-keywords` AI task + admin suggestion endpoint requires a future spec revision
  after [`ai-expansion`](../20-ai-expansion/spec.md); expansions remain operator-reviewed and
