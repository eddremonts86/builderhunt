...
> **Depends on**: [`ai-expansion`](../ai-expansion/spec.md) (hard — complete), [`code-fingerprinting`](../code-fingerprinting/spec.md) (soft — v1 heuristic only, v2 hasn't landed), [`ai-profile-enrichment`](../ai-profile-enrichment/spec.md) (soft — complete), [`team-accounts`](../team-accounts/spec.md) (soft — complete)
> **Blocks**: nothing
