...
> **Status**: `pending`
> **Depends on**: [`ai-expansion`](../ai-expansion/spec.md) (hard — task registry, `minimaxChat`, cache, budgets), [`code-fingerprinting`](../code-fingerprinting/spec.md) (soft — works with v1 heuristic fingerprints; v2 AI fingerprints sharpen it), [`ai-profile-enrichment`](../ai-profile-enrichment/spec.md) (soft — enrichment enriches inputs when present), [`team-accounts`](../team-accounts/spec.md) (soft — v1 uses the individual recruiter's tracked builders as "the team"; org-shared lists plug in later)
> **Blocks**: nothing
