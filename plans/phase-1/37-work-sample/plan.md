...
> **Status**: `pending`
> **Depends on**: [`ai-expansion`](../20-ai-expansion/spec.md) (hard), [`code-fingerprinting`](../24-code-fingerprinting/spec.md) (soft — shared `src/lib/github/content.ts`; whichever ships first introduces it)
> **Blocks**: nothing. **Supersedes**: [`technical-sandbox`](../38-technical-sandbox/plan.md).
