...
> **Depends on**: [`ai-expansion`](../20-ai-expansion/spec.md) (hard), [`code-fingerprinting`](../24-code-fingerprinting/spec.md) (soft — `src/lib/github/work-sample.ts` — see note below)
> **Blocks**: nothing. **Supersedes**: [`technical-sandbox`](../38-technical-sandbox/tasks.md).
