...
`plans/waitlist-launch/spec.md`. Adding named customer quotes without written permission would be
...
- no performance regression beyond the budgets in `plans/audit-performance-qa/spec.md`;
