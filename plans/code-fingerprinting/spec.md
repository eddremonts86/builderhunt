...
> **Depends on**: [`ai-expansion`](../ai-expansion/spec.md) (AI Platform — `minimaxChat`, task registry, cache, budgets)
> **Blocks**: [`team-synergy`](../team-synergy/spec.md) (soft — synergy works with v1 heuristic fingerprints but improves with v2), [`work-sample`](../work-sample/spec.md) (soft — shares the GitHub content-fetch helpers introduced here)
...
- No pgvector / embedding representation — the fingerprint stays a 5-metric + paradigm
  record compared with the existing pure `similarity()` function ([`semantic-search`](../semantic-search/spec.md)
...
Implemented in `src/lib/github/content.ts` (shared with [`work-sample`](../work-sample/spec.md),
...
- **Future (cut from this plan)**: global cross-user style search. Requires a global
  ...
  [`semantic-search`](../semantic-search/spec.md) is the precedent to extend, not a second
