...
> **Status**: `pending`
> **Depends on**: [`job-opportunities-workspace`](../job-opportunities-workspace/spec.md) (sólo fases 7–8), [`ai-expansion`](../../implemented/phase-1/21-ai-expansion/spec.md), [`security-and-multitenancy`](../../implemented/phase-1/01-security-and-multitenancy/spec.md)
