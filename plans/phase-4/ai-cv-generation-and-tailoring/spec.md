...
> **Status**: `pending`
> **Depends on**: [`job-opportunities-workspace`](../job-opportunities-workspace/spec.md) (modelo `job_opportunities`/`job_opportunity_versions` y el `career-principal`; sin él sólo se pierde el tailoring, no el CV base), [`ai-expansion`](../../implemented/phase-1/21-ai-expansion/spec.md) (registry de tasks, budget, caché, MiniMax), [`security-and-multitenancy`](../../implemented/phase-1/01-security-and-multitenancy/spec.md) (`withTenantContext`, RLS, roles)
