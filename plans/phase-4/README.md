...
([`postgres-18-upgrade`](../implemented/phase-1/03-postgres-18-upgrade/spec.md), added 2026-07-26;
...
| ---- | ---------- | ----: | ------- |
| [`postgres-18-upgrade`](../implemented/phase-1/03-postgres-18-upgrade/spec.md) | PostgreSQL 16 → 18 across dev/CI/prod, then the four PG18 capabilities that touch existing code | 39 | **Moved to phase-1 as `03-postgres-18-upgrade` on 2026-07-28** — no longer part of this phase |
