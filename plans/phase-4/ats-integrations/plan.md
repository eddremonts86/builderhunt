...
> **Status**: `pending`
> **Depends on**: [`hiring-pipeline-kanban`](../hiring-pipeline-kanban/plan.md) (hard — the pipeline stage model this plan maps external ATS status onto); [`security-and-multitenancy`](../../implemented/phase-1/01-security-and-multitenancy/plan.md) (per-organization third-party credentials, RLS, tenant-scoped sync state); [`stripe-billing-platform`](../../implemented/phase-1/30-stripe-billing-platform/plan.md) (the Team-tier gate this feature sells into does not bill anyone yet); [`legal-and-compliance`](../../implemented/phase-1/04-legal-and-compliance/plan.md) (candidate data leaving the product to a third-party processor).
> **Blocks**: nothing
