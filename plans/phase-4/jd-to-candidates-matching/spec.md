...
- **Not `solutions-intelligence`.** That plan turns a *structured `SolutionBrief`* into up to
  ...
  ([`solutions-intelligence`](../../implemented/43-solutions-intelligence/spec.md)). This plan turns
...
[`legal-and-compliance`](../../implemented/04-legal-and-compliance/spec.md)) already names MiniMax M3 and
