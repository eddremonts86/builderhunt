...
| Surface | Server work |
|---|---|
| `admin/users` | Delete `listPlatformUsersWithPlans`'s unbounded form. New capability with server-side search over name and email, replacing the client filter at `users.tsx:110`. |
