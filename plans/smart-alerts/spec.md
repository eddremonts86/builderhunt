...
| Pure matcher `evaluateMatch(conditions, builder, event)` + `recordTrigger`, `listTriggersForUser`, `markTriggerRead`, `unreadTriggerCount`                                                                                                                                             | `src/shared/lib/alerts.ts`, tests in `src/shared/lib/alerts.test.ts` |
