...
> **Reality check**: One next-free generated migration plus one unit test; reuse the indexes already
> declared wherever they match, and recount at execution time. As executed that was
> `drizzle/0155_table_sort_indexes.sql` (`capability-index.ts`, 13 tests) — plan 08 later added
> `0156` for the abuse console.
