...
- [ ] **Crear el paquete de investigación**
  - Files: `docs/research/phase-3/interview-guide.es.md`, `docs/research/phase-3/scorecard.es.md`, `docs/research/phase-3/recruiting-screener.es.md`
...
- [ ] **Registrar el baseline**
  - Files: `docs/research/phase-3/baseline.es.md`
...
- [ ] **Entrevistar cinco perfiles de hiring**
  - Files: `docs/research/phase-3/findings-hiring.es.md`
...
- [ ] **Entrevistar cinco perfiles de investing**
  - Files: `docs/research/phase-3/findings-investing.es.md`
...
- [ ] **Entrevistar cinco perfiles de building**
  - Files: `docs/research/phase-3/findings-building.es.md`
...
- [ ] **Contrastar la síntesis con Claude**
  - Files: `docs/research/phase-3/claude-critique.es.md`
...
- [ ] **Cerrar la decisión de ICP**
  - Files: `docs/research/phase-3/icp-decision.es.md`
