...
`plans/implemented/phase-1/54-waitlist-launch/spec.md`. Adding named customer quotes without written permission would be
...
- no performance regression beyond the budgets in `plans/implemented/phase-1/49-audit-performance-qa/spec.md`;
