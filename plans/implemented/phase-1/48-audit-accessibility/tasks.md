...
- [x] **Repair names, roles, labels, landmarks, and announcements from the baseline**
  ...
  - Do: Fixed every failure axe actually proved, live, across the full route matrix (not a
    ...
    - `.table-scroll` wrapper (new in this session, `plans/implemented/phase-1/07-responsive-mobile-design`) needed
...
- [x] **Run final production-like smoke and record rollout evidence** — closed out 2026-07-25 to
  ...
  - Files: `plans/implemented/phase-1/48-audit-accessibility/spec.md`, `plans/implemented/phase-1/48-audit-accessibility/plan.md`,
    `plans/implemented/phase-1/48-audit-accessibility/tasks.md`, `docs/accessibility-verification.md`
