...
> **Status**: `implemented` (Persona Card shipped for tracked builders; claim-triggered
> auto-refresh shipped 2026-07-25 — corrected 2026-07-31, this line said "deferred" long after it
> shipped, see tasks.md)
> **Depends on**: [`ai-expansion`](../21-ai-expansion/spec.md) (AI Platform — `minimaxChat`, task registry, cache, budgets must exist through Phase 3)
> **Blocks**: nothing
...
[`semantic-search`](../22-semantic-search/spec.md)), enrichment can migrate to it; `version: 1`
