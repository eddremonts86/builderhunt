...
- [x] **Enforce Team downgrade seat blockers**
  ...
  - Progress (2026-07-23): Reuses the EXACT same seat count `getSeatUsage` (organization-lifecycle.ts,
    already shipped by plans/implemented/phase-1/27-team-accounts) already enforces at invite time — "accepted members plus
...
- [x] **Reconcile dependent plan documents**
  - Files: `plans/implemented/phase-1/44-calendar-scheduling-interview-intelligence/spec.md`, `plans/implemented/phase-1/44-calendar-scheduling-interview-intelligence/plan.md`
...
- [x] **Certify Stripe sandbox and Test Clock lifecycle** — closed 2026-08-03
  ...
  **Closed 2026-08-03. What unblocked it was not new information about Stripe — it was that this task's own
  ...
  effort (`plans/implemented/phase-1/53-exhaustive-local-e2e-design/`… all present as untracked work at the time of
...
on 2026-08-05** — it needs real money: a live catalog, a voluntary Danish customer, a real charge, a real
refund, and a real payout with FX. Seven of its nine observations were already split out and closed in
2026-08-04; the two that remain are the ones no engineering can produce.
