...
> **Blocks**: nothing. **Supersedes**: [`technical-sandbox`](../../../rejected/phase-1/39-technical-sandbox/spec.md) (merged into this plan — see its status header for rationale; its surviving kernel is this task's `suggestedInterviewQuestions` output).
