...
- **AI persona**: if [`ai-profile-enrichment`](../24-ai-profile-enrichment/spec.md) is shipped,
...
- **Timeline**: if [`unified-timeline`](../33-unified-timeline/spec.md) is shipped and enabled by
