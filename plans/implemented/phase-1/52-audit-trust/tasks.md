...
> **Depends on**: [`audit-performance-qa`](../49-audit-performance-qa/spec.md), [`pricing-and-billing`](../../../rejected/phase-1/31-pricing-and-billing/spec.md), [`legal-and-compliance`](../04-legal-and-compliance/spec.md), [`claimable-profiles`](../36-claimable-profiles/spec.md)
...
- [x] **Replace email-only builder verification with source proof** — done, but by an earlier
  ...
  - This plan's task duplicates that work almost exactly (require a matching source-hosted
    ...
    `plans/implemented/phase-1/36-claimable-profiles/tasks.md`'s "Canonical identity and proof" section for the
