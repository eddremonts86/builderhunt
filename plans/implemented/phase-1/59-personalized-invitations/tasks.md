...
- [x] **Verify the complete flow manually and close only on the full gate**
  - Files: `docs/operations/personalized-invitations-verification.md`,
    `plans/implemented/phase-1/59-personalized-invitations/spec.md`,
    `plans/implemented/phase-1/59-personalized-invitations/plan.md`,
    `plans/implemented/phase-1/59-personalized-invitations/tasks.md`
  ...
  - Verify: the evidence file maps every acceptance criterion to a screenshot/test/command and
    includes a zero exit code for the final `pnpm ci:local`; `rg -n '^- \[ \]' plans/implemented/phase-1/59-personalized-invitations/tasks.md`
