...
- [x] **Enforce Team downgrade seat blockers**
  ...
  - Progress (2026-07-23): Reuses the EXACT same seat count `getSeatUsage` (organization-lifecycle.ts,
    already shipped by plans/implemented/27-team-accounts) already enforces at invite time — "accepted members plus
...
- [x] **Reconcile dependent plan documents**
  - Files: `plans/implemented/44-calendar-scheduling-interview-intelligence/spec.md`, `plans/implemented/44-calendar-scheduling-interview-intelligence/plan.md`
...
- [x] **Certify Stripe sandbox and Test Clock lifecycle** — closed 2026-08-03
  ...
  **Closed 2026-08-03. What unblocked it was not new information about Stripe — it was that this task's own
  ...
  effort (`plans/implemented/53-exhaustive-local-e2e-design/`… all present as untracked work at the time of
