...
const authDbAllowlist = new Set([
  ...
  // (abuse/linked-accounts.ts, plans/implemented/32-abuse-and-usage-integrity/tasks.md Phase 3) — same exception
...
// reimplementing role logic inline (plans/implemented/27-team-accounts/tasks.md's own
